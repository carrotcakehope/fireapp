...
const CALC_MODES = {
  inspect_report: {
    ...
    tableBody: [
      ...
      ["업체 위탁", "① 자체점검 실시결과 보고서<br>② 점검인력 배치확인서"],
  ...
  fire_safety_manager: {
    ...
    tableBody: [
      ...
      ["소방시설관리업체<br>대행 선임", "① 소방안전관리자 선임신고서<br>② 소방안전관리 업무 감독 증명서류<br>③ 소방안전관리업무의 대행 계약서 사본<br>④ 소방시설관리업등록증(2022.12.1부터 필수X)<br> ⑤ 소방시설관리사수첩(2022.12.1부터 필수X)"],
    ],
    extraSections: [
      {
