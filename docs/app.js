...
const RG_FACILITY_DESCS = {
  ...
  'ac02': [
    '해당 특정소방대상물에 옥내소화전설비나 스프링클러설비 등 수계소화설비가 설치되어 있고, 규모가 엄청 큰 경우가 아니면 연결송수관 설비는 대부분 다른 수계소화설비와 배관을 겸용하여 설치합니다.',
    '연결송수관 설비가 설치된 설치장소 동명과 층 범위를 기재합니다.',
    '방수구 위치 및 송수구 설치장소 : 방수구와 송수구가 설치된 장소를 확인하여 기입합니다.',
    ...
    '가압송수장치가 설치된 장소 및 전양정과 토출량 등을 기입합니다.',
    '기동스위치 설치장소: 가압송수장치를 기동시키는 스위치가 설치된 장소를 기입합니다. 주로 송수구 근처에 설치됩니다.',
  ],
  'ac03': [
    '방식: 살수설비가 습식(폐쇄형 헤드사용, 배관내부 물로 차있음)인지 건식(개방형 헤드사용, 배관내부 평상시 공기)인지 확인하여 기입합니다. 대부분 건식으로 설치됩니다.',
    '지하층과 판매시설, 가스시설 등 중 살수설비가 설치된 법적기준(왜 설치했는지)을 확인하여 기입합니다.',
    '송수구가 설치된 장소와 송수구역 수를 확인하여 기입합니다.',
  ],
  'ac04': [
    '비상콘센트 설비가 설치된 동명과 층을 기재합니다.',
    '전원방식과 접속기 형식을 확인하여 해당하는 란에 ✔표시합니다. 오래된 건물(고층 빌딩 등)을 제외하고 현재에는 단상 220V와 접지형 2극 플러그접속기를 설치합니다.',
  ],
  'ac05': [
